...
description: Load when drafting or revising a specification from existing Vault sources while preserving precedence and evidence quality.
metadata:
  canonical_title: Specification Session
  source_id: workflow.operational.spec-session
  source_path: operational/spec-session.md
---
