...
description: Load when a question requires resolving conflicts between Vault documents by canonical precedence.
metadata:
  canonical_title: Knowledge Precedence
  source_id: governance.precedence
  source_path: governance/precedence.md
---
