...
description: Load when extracting reusable lessons from issues, reviews, experiments, or cross-repo work and deciding how to promote them.
metadata:
  canonical_title: Reflection Loop
  source_id: docs.reflection-loop
  source_path: docs/reflection-loop.md
---
